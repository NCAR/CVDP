...
def createNameList(ref_path: str, sim_path: str, namels_dir_path="variable_namelists"):
    if not os.path.exists(namels_dir_path): 
          
        # if the demo_folder directory is not present  
        # then create it. 
        os.makedirs(namels_dir_path) 
    ...
    if os.path.isfile(f'{namels_dir_path}/namelist_pr'):
        os.remove(f'{namels_dir_path}/namelist_pr')
    ...
    with open(f'{namels_dir_path}/namelist_pr', 'w') as f:
    ...
    if os.path.isfile('namelist_psl'):
        os.remove(f'{namels_dir_path}/namelist_psl')
    ...
    with open(f'{namels_dir_path}/namelist_psl', 'w') as f:
    ...
    if os.path.isfile('namelist_tas'):
        os.remove(f'{namels_dir_path}/namelist_tas')
    ...
    with open(f'{namels_dir_path}/namelist_tas', 'w') as f:
    ...
    if os.path.isfile('namelist_ts'):
        os.remove(f'{namels_dir_path}/namelist_ts')
    ...
    with open(f'{namels_dir_path}/namelist_ts', 'w') as f:
    ...
    if os.path.isfile('namelist_zos'):
        os.remove(f'{namels_dir_path}/namelist_zos')
